  ...
  return (
    ...
    >
      ...
      <p className="text-lg lg:text-2xl font-medium text-justify">
        ...
        cars, evaluating them based on their condition. If your car is in good
        shape, simply drive it to us and receive generous compensation.
        <br />
        <br />
        Sell your Junk Car For Cash to Ari-Car, America&apos;s top junk car
        buyer that operates across the United States. With us, you&apos;ll get
        the highest cash offer and a hassle-free experience!
      </p>
    </div>
  );
}
